...
/**
 * SingletoneInstanceFactoryが生成するインスタンスについて、メソッド実行中のトランザクションについての確認
 * 
 * @author naoco0917
 */
public class SingletoneInstanceFactoryTest01 {
	...
	/**
	 * SingletoneInstanceFactoryで取得したインスタンスについて、メソッド内の接続操作と、メソッド終了後の接続クローズを確認
	 * 
	 * @throws Exception
	 */
	@Test
	public void test01() throws Exception {
		...
		// 初期設定
		NaocoCoreInitializer.initialize(SingletoneInstanceFactoryTest01.class.getName() + "_test01", null);
		...
		// インスタンスを生成
		TestInterface instance = new SingletoneInstanceFactory<TestInterface>(TestInterface.class, Test01Impl.class)
				.getInsatnce();
	...
	/**
	 * SingletoneInstanceFactoryで取得したインスタンスについて、メソッド内の接続操作と、メソッド終了後のロールバックを確認
	 * 
	 * @throws Exception
	 */
	@Test
	public void test02() throws Exception {
		...
		// 初期設定
		NaocoCoreInitializer.initialize(SingletoneInstanceFactoryTest01.class.getName() + "_test02", null);
	...
	public void test03() throws Exception {
		...
		// 初期設定
		NaocoCoreInitializer.initialize(SingletoneInstanceFactoryTest01.class.getName() + "_test03", null);
		...
		class Handler01 implements TestHandler {
			...
			public void handle(TestHandler... handle) throws Exception {
				...
				// 次の処理を呼出し
				TestInterface instance = new SingletoneInstanceFactory<TestInterface>(TestInterface.class,
	...
	public void test04() throws Exception {
		...
		// 初期設定
		NaocoCoreInitializer.initialize(SingletoneInstanceFactoryTest01.class.getName() + "_test04", null);
		...
		// インスタンスを生成
		TestInterface instance = new SingletoneInstanceFactory<TestInterface>(TestInterface.class, Test11Impl.class)
				.getInsatnce();
		Handler01 handler01 = new Handler01();
		handler01.setLookupName(lookupname01);
		handler01.setSql(sql01);
	...
	public void test05() throws Exception {
		...
		// 初期設定
		NaocoCoreInitializer.initialize(SingletoneInstanceFactoryTest01.class.getName() + "_test05", null);
